    ...
    */
    ...
    public static String csvToJson(String csvString) {
        ...
        try {
            ...
            while (iterator.hasNext()) {    // goes through all records
                line=iterator.next();       //Gets next row
    ...
    public static String jsonToCsv(String jsonString) {
        ...
        try {
           ...
           JSONArray store;
           String[] info = new String[cols.size()];

                    
           for (int i = 0; i < cols.size(); ++i) {
               info[i] = (String)cols.get(i);     //Convert Object to String
           }
           ...
           for (int i = 0; i < data.size(); ++i) {
               ...
               for (int n = 0;n <  store.size(); n++) {
                   info[n + 1] = Long.toString((long) store.get(n));
               }
